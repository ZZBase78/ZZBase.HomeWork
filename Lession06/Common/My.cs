...
namespace Lession06
{
    ...
    class My
    {
        ...
        /// <param name="question"></param> текст вопроса
        /// <returns></returns>
        static public double SlowReadDouble(string question)
        {
            ConsoleColor current_color = Console.ForegroundColor;
            ConsoleColor error_color = ConsoleColor.Red;
            double result;
        ...
        /// <summary>
        /// Выводит текст сообщения указанным цветом
        /// </summary>
        /// <param name="text">текст сообщения</param>
        /// <param name="color">цвет текста</param>
        static public void Message(string text, ConsoleColor color)
        {
            ConsoleColor cur_color = Console.ForegroundColor;
        ...
        /// </summary>
        /// <param name="text">текст для вывода</param>
        static public void SlowMessage(string text)
        {
            for (int i = 0; i < text.Length; i++)
            {
                Console.Write(text[i]);
